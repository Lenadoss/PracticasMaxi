     ...
     public void Agregar(Articulo NuevoArticulo)
        {
            ...
            {
                MessageBox.Show(ex.ToString(), "Insertando", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                Datos.CerrarConexion();
        ...
        public void Modificar(Articulo Modificar)
        {
            ...
            {
                MessageBox.Show(ex.ToString(), "Modificando", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                Datos.CerrarConexion();
